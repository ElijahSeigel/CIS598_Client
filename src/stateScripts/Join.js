...
export default class Join{
	...
	render(ctx, ownerFlag, width, height, input){
		...
		//input.style = "text-transform:uppercase; text-align: center; background-color: #1B4F72; color: #3498db; position:fixed; top:"+8*height/18+"px; left:"+width/16+"px; width:"+7*width/8+"px; height:"+3*height/18+"px; font:"+font_size+"px courier;";
			input.style = "text-transform:uppercase; text-align: center; background-color: #1B4F72; color: #3498db; position:fixed; top:"+8*height/18+"px; left:"+width/32+"px; width:"+7*width/16+"px; height:"+3*height/20+"px; font:"+font_size+"px courier;";
